...
describe('cache gate end-to-end (PGLite)', () => {
  ...
  test('content UPDATE on a result page → lookup MISS (per-page bumped)', async () => {
    ...
    const results: SearchResult[] = [
      { page_id: p1, slug: 'test/p1', title: 'test/p1', snippet: 'x', score: 1.0 } as SearchResult,
    ];
  ...
  test('INSERT new page → lookup HIT (bookmark fires but snapshot intact — codex #4 case)', async () => {
    ...
    const results: SearchResult[] = [
      { page_id: p1, slug: 'test/p1', title: 'test/p1', snippet: 'a', score: 1.0 } as SearchResult,
    ];
  ...
  test('legacy row (pre-v0.40.5.0 shape) serves normally — IRON-RULE backward compat', async () => {
    ...
    const results: SearchResult[] = [
      { page_id: p1, slug: 'test/p1', title: 'test/p1', snippet: 'g', score: 1.0 } as SearchResult,
    ];
  ...
  test('soft-delete result page → lookup MISS (trigger bumps generation)', async () => {
    ...
    const results: SearchResult[] = [
      { page_id: p1, slug: 'test/p1', title: 'test/p1', snippet: 'e', score: 1.0 } as SearchResult,
    ];
  ...
  test('multi-page result: partial bump invalidates (one of two result pages changed)', async () => {
    ...
    const results: SearchResult[] = [
      { page_id: p1, slug: 'test/p1', title: 'test/p1', snippet: 'z', score: 1.0 } as SearchResult,
      { page_id: p2, slug: 'test/p2', title: 'test/p2', snippet: 'e', score: 0.9 } as SearchResult,
    ];
